...
void getDistance(int start_star[2],int end[2],char map[100][100],int dis[8])
{	
	int direct[2];
	//up
	direct[0]=1;
...
bool huiSu(int start[2],int end[2],char map[100][100],int direct[2])
{
	...
	if (isHuisuable(start,directions,map)&&(isHuisuable(start,directions1,map)||isHuisuable(start,directions2,map)))
	{
		start_temp[0]=start[0]+directions[0];
		start_temp[1]=start[1]+directions[1];
		dist[4]=distance(start_temp,end);
	}
	//down left
	directions1[0]=-1;
	directions1[1]=0;
	...
	if (isHuisuable(start,directions,map)&&(isHuisuable(start,directions1,map)||isHuisuable(start,directions2,map)))
	{
		start_temp[0]=start[0]+directions[0];
		start_temp[1]=start[1]+directions[1];
		dist[5]=distance(start_temp,end);
	}
	//up right
	directions1[0]=1;
	directions1[1]=0;
	...
	if (isHuisuable(start,directions,map)&&(isHuisuable(start,directions1,map)||isHuisuable(start,directions2,map)))
	{
		start_temp[0]=start[0]+directions[0];
		start_temp[1]=start[1]+directions[1];
		dist[6]=distance(start_temp,end);
	}
	//down right
	directions1[0]=-1;
	directions1[1]=0;
	...
	if (isHuisuable(start,directions,map)&&(isHuisuable(start,directions1,map)||isHuisuable(start,directions2,map)))
	{
		start_temp[0]=start[0]+directions[0];
		start_temp[1]=start[1]+directions[1];
		dist[7]=distance(start_temp,end);
	}
...
int search(int start[2],int end[2],char map[100][100],int& dist)
{
	...
	{
         map[start[0]][start[1]]='$';
		int flag1=huiSu(start,end,map,direc);
		 if (direc[0]==0&&direc[1]==0)
		 {
			 return inf_distance;
		 }
